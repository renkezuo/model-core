...
@Component
public class MyWxMpService implements WxMpService {

	protected final Logger logger = LoggerFactory.getLogger(MyWxMpService.class);
	...
	public WxMpPrepayIdResult getPrepayId(String openId, String outTradeNo, double amt, String body, String tradeType,
		...
		String xml = "<xml>" + "<appid>" + wxMpConfigStorage.getAppId() + "</appid>" + "<mch_id>"
				+ wxMpConfigStorage.getPartnerId() + "</mch_id>" + "<nonce_str>" + nonce_str + "</nonce_str>" + "<sign>"
				+ sign + "</sign>" + "<body><![CDATA[" + body + "]]></body>" + "<out_trade_no>" + outTradeNo
				+ "</out_trade_no>" + "<total_fee>" + packageParams.get("total_fee") + "</total_fee>"
				+ "<spbill_create_ip>" + ip + "</spbill_create_ip>" + "<notify_url>" + callbackUrl + "</notify_url>"
		...
		try {
			...
			System.out.println("xml:====="+wxMpPrepayIdResult.getPrepay_id());
	...
	public Map<String, String> getJSSDKPayInfo(String openId, String outTradeNo, double amt, String body,
		...
		if (prepayId == null || prepayId.equals("")) {
			throw new RuntimeException("get prepayid error:" + wxMpPrepayIdResult.getReturn_code() + ":"
					+ wxMpPrepayIdResult.getReturn_msg());
		}
	...
	public WxMpPayResult getJSSDKPayResult(String transactionId, String outTradeNo) {
		...
		String sign = WxCryptUtil.createSign(packageParams, wxMpConfigStorage.getPartnerKey());
		String xml = "<xml>" + "<appid>" + wxMpConfigStorage.getAppId() + "</appid>" + "<mch_id>"
				+ wxMpConfigStorage.getPartnerId() + "</mch_id>";
		...
		xml += "<nonce_str>" + nonce_str + "</nonce_str>" + "<sign>" + sign + "</sign>" + "</xml>";
