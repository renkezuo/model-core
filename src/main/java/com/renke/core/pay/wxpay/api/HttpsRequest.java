...
import com.renke.core.tools.RedisTool;
...
//    }
    ...
    private void init() throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        FileInputStream instream = new FileInputStream(new File(WXpayConfig.cert_p12));//加载本地的证书进行https加密传输
        try {
            keyStore.load(instream, WXpayConfig.mch_id.toCharArray());//设置证书密码
...
//        XStream xStreamForRequestPostData = new XStream(new DomDriver("UTF-8", new XmlFriendlyNameCoder("-_", "_")));
    ...
    public String getToken(){
    	return RedisTool.getRedisValueByKey("mhns_wx_token");
    }
